...
curr_file <- "wages_simple9-08a.stan"
...
save(fit_ifls, file = "fit_ifls_9-08a.rda")

curr_file <- "wages_simple9-08b.stan"
...
save(fit_ifls, file = "fit_ifls_9-08b.rda")

curr_file <- "wages_simple9-08c.stan"
...
save(fit_ifls, file = "fit_ifls_9-08c.rda")

curr_file <- "wages_simple9-08d.stan"
...
save(fit_ifls, file = "fit_ifls_9-08d.rda")